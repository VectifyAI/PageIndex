...
```bash
CHATGPT_API_KEY=your_deepseek_key_here
CHATGPT_BASE_URL=https://api.deepseek.com
```
...
```
--model                 Chat model to use (default: gpt-4o-2024-11-20)
...
```bash
python3 run_pageindex.py --pdf_path /path/to/your/document.pdf --model deepseek-chat
```
</details>
